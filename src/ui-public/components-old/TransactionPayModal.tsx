...
import { Image, Linking, StyleSheet, ToastAndroid, useWindowDimensions, View } from 'react-native';
...
import { httpService, imageManager, ImageManagerParams } from '../../lib/utilities';
        ...
        >
          ...
          <Typography type="h4" color="primary" textAlign="center" style={{ marginTop: 12 }}>
            {'transfer' === paymentMethodType ? (
              t(`Pembayaran Diverifikasi`).toUpperCase()
            ) : (
